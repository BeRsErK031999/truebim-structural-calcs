...
export const pilotQuickStartSteps = [
  ...
  },
  {
    ...
    description: 'Просмотрите отчет в приложении или скачайте HTML/Markdown, затем зафиксируйте все допущения.',
    href: '/',
  },
  {
  ...
  },
  {
    ...
    description: 'Свяжите доказательства проверки, заморозьте регрессионный контекст и выгрузите пакет валидации.',
    href: '/validation-session',
  },
  {
    title: 'Передать пакет разработчику',
    description: 'Верните отчет, снимок проверки, JSON кандидата, пакет валидации и JSON с отзывами.',
...
export const pilotReadinessNotes = [
  ...
  'Геометрия продавливания у конца стены и в углу стены остается черновой и требует доверенной проверки перед проектным применением.',
...
export const pilotUsableItems = [
  ...
  'Просматривать отчет в приложении или скачивать HTML/Markdown-отчеты для пакетов валидации.',
...
export const pilotRoadmapItems = [
  ...
  'Геометрия продавливания в углу стены',
