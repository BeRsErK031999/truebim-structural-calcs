...
| multiple control perimeters | Public page states multiple calculation contours are considered. | Single draft control perimeter flow. | missing | Add contour generation, selection logic, comparison rules, UI table, and report trace. | P0 |
